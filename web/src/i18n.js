const translations = {
  ...
  '连续听写': 'Continuous',
  '单次听写': 'Single pass',
  '听写快捷键': 'Dictation shortcut',
  '发送后继续听写': 'Continue dictation after sending',
  '听写未开启': 'Dictation is off',
  '正在听写': 'Dictating',
  '听写已加入草稿': 'Dictation added to draft',
  '听写已修改草稿': 'Dictation updated the draft',
  '听写已删除最后一句': 'Dictation removed the last sentence',
  '听写已发送': 'Dictation sent the draft',
  '没有可发送的草稿': 'There is no draft to send',
  '没有找到要修改的文字': 'The text to change was not found',
  '草稿中没有可删除的句子': 'There is no sentence to delete in the draft',
  '请先关闭实时语音再使用听写': 'Turn off realtime voice before using dictation',
  '当前浏览器不支持听写': 'This browser does not support dictation',
  '浏览器没有听写权限': 'The browser did not grant dictation permission',
  '浏览器听写服务不可用': 'The browser dictation service is unavailable',
  '听写失败，请稍后重试': 'Dictation failed, please try again later',
